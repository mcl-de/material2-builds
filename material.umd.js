...
var MdSnackBarContainer = (function (_super) {
    ...
    MdSnackBarContainer = __decorate$35([
        _angular_core.Component({selector: 'snack-bar-container',
            ...
            styles: [":host { box-shadow: 0px 11px 15px -7px rgba(0, 0, 0, 0.2), 0px 24px 38px 3px rgba(0, 0, 0, 0.14), 0px 9px 46px 8px rgba(0, 0, 0, 0.12); background: #323232; border-radius: 2px; display: block; height: 20px; max-width: 568px; min-width: 288px; overflow: hidden; padding: 14px 24px; box-sizing: content-box; } /*# sourceMappingURL=snack-bar-container.css.map */ "],
            host: {
                'role': 'alert'
            }
        }), 
    ...
    Object.defineProperty(MdTooltip.prototype, "message", {
        ...
        set: function (value) {
            ...
            if (this.message) {
                ...
                if (this.visible) {
                    this.hide();
                    showAfterChange_1 = true;
                }
                setTimeout(function () {
                    _this._message = value;
                    _this._updatePosition();
                    if (showAfterChange_1) {
                        _this.show();
                    }
                }, 0);
            }
...
var TooltipComponent = (function () {
    ...
    TooltipComponent = __decorate$43([
        _angular_core.Component({selector: 'md-tooltip-component',
            ...
            styles: [":host { pointer-events: none; } .md-tooltip { color: white; padding: 0 8px; border-radius: 2px; font-family: Roboto, \"Helvetica Neue\", sans-serif; font-size: 10px; margin: 14px; line-height: 14px; } /*# sourceMappingURL=tooltip.css.map */ "],
        }), 
